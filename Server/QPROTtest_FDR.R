...
#}
fileIn <- 'PXD007592_1up_Normalyser_qprot_qprot_fdr'
dataSet <- 'PXD0007592'
#setwd('/mnt/hc-storage/users/hprice/Pipeline/QPROTresults')
#fileIn <- paste(dataSet, "_1up_Normalyser_qprot_qprot_fdr", sep = '')
...
outFile <- paste(fileIn, "_FDRresults.csv", sep = '')

example_qprot_fdr <- read.table(fileIn, header = TRUE, sep = '\t')
